...
import { TimeTrackingList } from "@/components/projects/time-tracking-list"
...
export function ProjectDetails({ project, tasks, timeEntries, userId, teamMembers }: { project: Project, tasks: Task[], timeEntries: TimeEntry[], userId: string, teamMembers: TeamMember[] }) {
