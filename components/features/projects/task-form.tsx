...
export function TaskForm({ projectId, task, teamMembers = [], onSuccess }: TaskFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (task) {
        ...
        result = await updateTask(task.id, dataToSubmit)
      } else {
        // Créer une nouvelle tâche
        result = await createTask(projectId, dataToSubmit)
      }
