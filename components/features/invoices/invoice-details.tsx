...
export function InvoiceDetails({ invoice, invoiceItems, payments, userId }: InvoiceDetailsProps) {
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Client: {invoice.clients.name}</p>
          </div>
        </div>
