      ...
      <Form {...props.form}>
        <form onSubmit={props.handleSubmit(props.onSubmit)} className="space-y-6">
          ...
          <div className="grid gap-6 grid-cols-1 md:grid-cols-2">
            <Card>
              ...
              <CardContent className="space-y-4">
                <InvoiceGeneralFields control={props.control} clients={props.clients} onClientCreated={props.handleClientCreated} />
              </CardContent>
            </Card>
            <Card>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div className="flex flex-col items-end gap-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium">{formatCurrency(props.subtotal, props.currency)}</span>
                  </div>
                  <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-lg font-semibold">{formatCurrency(props.total, props.currency)}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-3 sm:space-x-4">
            <Button type="button" variant="outline" onClick={props.onCancel} className="w-full sm:w-auto">Annuler</Button>
